...
def process_data_on_current_dir() -> pd.DataFrame:
    '''
    ...
    for filename in listdir():
        if '.txt' not in filename:
            ...
            try:
                chat_interventions = chat_interventions.append(reading_class(filename))    
            except:
                print('error on', filename)
    
    return chat_interventions
            
chatInterventions = process_data_on_current_dir()
chatInterventions.to_csv('clean_chat_data.csv')
